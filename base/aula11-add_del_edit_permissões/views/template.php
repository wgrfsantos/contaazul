...
<head>
    ...
    <meta name="description" content="WVsoft | Sistemas" />
	<meta name="author" content="Wellington V. Santos" />
	...
	<script src="https://kit.fontawesome.com/e0156fa967.js" crossorigin="anonymous"></script>
</head><!--/head-->
    ...
    <div class="wrapper">
      ...
      <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="<?php echo BASE_URL; ?>"><p>Olá,  <?php echo $viewData['user_name'];?>!</p></a>
          </li>     
          <li class="nav-item">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="<?php echo BASE_URL; ?>" class="brand-link">
          <img src="<?php echo BASE_URL; ?>assets/images/logo_sem_fundo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
          <span class="brand-text font-weight-light"><?php echo $viewData['company_name'];?></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-<?php echo date('Y'); ?> <a href="">WVSOFT SISTEMAS</a>.</strong> Todos os direitos reservados.
      </footer>
    </div>
